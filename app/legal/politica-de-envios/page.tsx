...
import { Truck, Zap, Clock, ShieldCheck, CheckCircle2, ChevronRight } from 'lucide-react';
...
export default function PoliticaDeEnviosPage() {
  return (
    <div className="flex flex-col min-h-screen bg-brand-cream">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-8 font-sans">
        {/* Title */}
        <div className="text-center space-y-3 pb-6 border-b border-stone-200">
          ...
          <p className="text-xs sm:text-sm text-stone-600 max-w-2xl mx-auto leading-relaxed font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Step 3 */}
          <div className="bg-white p-6 rounded-xl border border-amber-300/80 bg-amber-50/20 shadow-xs space-y-3">
        ...
        {/* Detailed Sections */}
        <div className="bg-white rounded-xl border border-stone-200/80 p-6 sm:p-8 space-y-6">
          <section className="space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-stone-700 pl-4 list-disc">
              <li>
          ...
          <section className="space-y-3 pt-4 border-t border-stone-100">
            ...
            <div className="pt-2">
              <Link
                href="/envio-express"
                className="inline-flex items-center gap-2 px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white font-bold text-xs uppercase tracking-wider rounded-lg transition shadow-md"
              >
